...
//#define U1GetOneByte	MY_urst1_Receive
#define U1GetOneByte	MY_urst1_Receive  							//用于和f1
#define U2GetOneByte	MY_urst2_Receive                //空闲未做应用
#define U3GetOneByte	NoUse            							 //用于linux，此处无定义
#define U4GetOneByte	AnoOF_GetOneByte 							 //光流
#define U5GetOneByte	ANO_DT_LX_Data_Receive_Prepare //IMU	
/*主体思路将接受的数据存在数组中，之后在每1ms触发一次DrvUartDataCheck对drvU1DataCheck
进行操作将数据送入我的宏定义的函数中*/
